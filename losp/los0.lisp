...
;;   ****************************** 
;;   ****** Temporary place for functions relating to fs development
;;   *************************
    

(defun read-all-partition-tables ()
  (progn
    (muerte.x86-pc.ata::read-partition-table 0 0)
    (muerte.x86-pc.ata::read-partition-table 0 1)    
